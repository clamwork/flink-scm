package com.djcps.flink.common.utils;


import com.djcps.flink.common.constant.PropertiesConstants;
...
public class KafkaConfigUtil {
    ...
    private static Map<KafkaTopicPartition, Long> buildOffsetByTime(Properties props, ParameterTool parameterTool, Long time) {
        ...
        Map<KafkaTopicPartition, Long> partitionOffset = new HashMap<>(16);
